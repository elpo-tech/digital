...
<body>
    ...
    <main class="nxl-container">
        <div class="nxl-content">
            <!-- [ page-header ] start -->
            <form method="POST" onsubmit="return validateForm();" action="{{route('gadget.supdate', $info->id)}}">
                @csrf
                <div class="page-header">
                    <div class="page-header-left d-flex align-items-center">
                        <div class="page-header-title">
                            <h5 class="m-b-10">SERVICE GADGET</h5>
                        </div>
                        <ul class="breadcrumb">
                        ...
                        <div class="page-header-right-items">
                            ...
                            <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    ...
                                    <span>Update Gadget Details</span>
                                </button>
                            ...
                            <div class="card border-top-0">
                                <div class="card-header p-0">
                                    ...
                                    <div class="card-body personal-info">
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="tsw" id="tname" class="form-control" value="{{$info->tsw}}" placeholder="Enter Technician Name">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4 align-items-center">
                                            <div class="col-lg-4">
                                                <label class="fw-semibold">Service Requested: </label>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                ...
                                                <div class="card-body personal-info">
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                <div class="input-group-text"><i class="feather-user"></i></div>
                                                                <input type="text" name="fname" class="form-control" id="fullnameInput" value="{{$info->fname}}" placeholder="Name" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="email" class="form-control" id="email" value="{{$info->email}}" placeholder="Email" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="phone" class="form-control" id="phone" value="{{$info->phone}}" placeholder="Phone" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="passwordTab" role="tabpanel">
                                                <div class="card-body personal-info">
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" name="brand" data-select2-selector="status" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="model" value="{{$info->model}}" class="form-control" id="model" placeholder="Enter Model" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="serial" value="{{$info->serial}}" class="form-control" id="serial" placeholder="Enter Serial Number/Tag" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control" name="color" id="color" cols="30" rows="7" placeholder="Enter Description" disabled>{{$info->color}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body pass-security">
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="pro" value="{{$info->pro}}" class="form-control" id="processor" placeholder="Enter Processor Details" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" min="0" name="ram" value="{{$info->ram}}" class="form-control" id="ram" placeholder="Enter RAM Size" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" data-select2-selector="status" name="tsto" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" min="0" name="sto" value="{{$info->sto}}" class="form-control" id="storage" placeholder="Enter Storage Size" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="os" value="{{$info->os}}" class="form-control" id="os" placeholder="Enter Operating System Details" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="billingTab" role="tabpanel">
                                                <div class="card-body pass-info">
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" name="screen" data-select2-selector="status" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" name="keyb" data-select2-selector="status" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" name="touch" data-select2-selector="status" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" name="port" data-select2-selector="status" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control" name="cdes" id="cdes" cols="30" rows="7" disabled placeholder="Enter Description">{{$info->cdes}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="subscriptionTab" role="tabpanel">
                                                <div class="card-body pass-info">
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                <textarea class="form-control" name="access" id="access" cols="30" rows="7" disabled placeholder="Enter Accessories">{{$info->access}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="notificationsTab" role="tabpanel">
                                                <div class="card-body pass-info">
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" data-select2-selector="status" name="shw" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <select class="form-control" data-select2-selector="status" name="ssw" disabled>
                                                    ...
                                                    <div class="row mb-4 align-items-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="input-group">
                                                                <textarea class="form-control" name="sdes" id="aboutInput" cols="30" rows="7" disabled placeholder="Service Description">{{$info->sdes}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
